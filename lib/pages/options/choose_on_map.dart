                ...
                child: Card(
                  ...
                  child: Padding(
                    ...
                    child: PopupMenuButton(
                      shadowColor: Color(0xFFCFC5A5),
                      surfaceTintColor: Color(0xFFCFC5A5),
                      tooltip: 'Map Type',
                      ...
                      trailing: IconButton(
                        ...
                        onPressed: () async {
                          ...
                          if (widget.canPopOnNextButtonTaped) {
                            ...
                            setState(() {
                              var _output = _address.split(',');
                              var _searchResults = _output;
                              _getAddressFromElement();
